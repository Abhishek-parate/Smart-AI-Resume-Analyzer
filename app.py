"""
All in One Smart Resume Analyzer - Main Application
"""
import streamlit as st

# Set page config at the very beginning
st.set_page_config(
    page_title="All in One Smart Resume Analyzer",
    page_icon="🚀",
    layout="wide"
)
...
class ResumeApp:
    ...
    def render_feedback_page(self):
        ...
        st.markdown("""
            <div class="feedback-header">
                ...
                <p>Help us improve All in One Smart Resume Analyzer with your valuable feedback</p>
            </div>
        """, unsafe_allow_html=True)
    ...
    def render_home(self):
        ...
        # Hero Section
        hero_section(
            "All in One Smart Resume Analyzer",
